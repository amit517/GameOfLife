...
class GameWorldKotlin(private val aliveCells: HashSet<CellKotlin> = hashSetOf()) {

    fun addCell(cell: CellKotlin) = aliveCells.add(cell)

    private fun getNeighbours(cell: CellKotlin): Set<CellKotlin> {
    ...
    private fun getNeighbourhood(cell: CellKotlin): Set<CellKotlin> {
